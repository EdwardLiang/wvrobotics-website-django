...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FrontPage.id'
        db.add_column(u'frontpage_frontpage', u'id',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'FrontPage.page_ptr'
        raise RuntimeError("Cannot reverse this migration. 'FrontPage.page_ptr' and its values cannot be restored.")
